...
|:-------------------------------------------------------------:|:--------------------------------------------------:|:----------------------------------------------:|:-------------------------------------------:|:---------------------------------------:|:--------------------------------------:|
| Before Incident             | During Incident                 | During Incident                                    | During Incident                                | During Incident                             | After Incident                               |
| Getting Capabilities to Handle | Decisioning How to Handle     | Handling the Threat   | Handling the Incident      | Handling the Environment     | Improving Capabilities to Handle |
